...
internal fun VideoDetailScreenStateHolder(
    ...
    // ★ 封面快照是全局残留状态, 必须校验「点击时的 bvid == 当前路由 bvid」,
    //   否则从我的页面看自己投稿等无列表快照场景会先闪上一个视频的封面
    val clickedBvidMatchesRoute =
        com.android.purebilibili.core.util.CardPositionManager.lastClickedBvid == bvid.trim()
    val miuixCoverSnapshot =
        com.android.purebilibili.core.ui.transition.LocalMiuixVideoCardTransitionState.current
            ...
            .takeIf { miuixVisualAssetsActive && clickedBvidMatchesRoute }

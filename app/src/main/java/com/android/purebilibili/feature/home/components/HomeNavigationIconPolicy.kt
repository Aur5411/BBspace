...
private fun resolveMiuixHomeNavigationIcon(
    ...
    if (selected) {
        val filledResource = when (role) {
            ...
            // 番剧：用电视/剧集图标，避免与「短视频」都用 Play 而混淆。
            HomeNavigationIconRole.ANIME -> R.drawable.ms_tv_fill_24
            else -> null
        }
    ...
    return when (role) {
        ...
        HomeNavigationIconRole.ANIME -> ImageVector.vectorResource(R.drawable.ms_tv_24)

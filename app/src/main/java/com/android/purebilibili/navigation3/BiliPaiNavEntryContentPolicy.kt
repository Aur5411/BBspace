...
internal fun resolveBiliPaiNavEntryContentRole(key: BiliPaiNavKey): BiliPaiNavEntryContentRole {
    return when (key) {
        ...
        BiliPaiNavKey.Credits -> BiliPaiNavEntryContentRole.CREDITS
        ...
        BiliPaiNavKey.AniFollow -> BiliPaiNavEntryContentRole.ANI_FOLLOW
        BiliPaiNavKey.AniHistory -> BiliPaiNavEntryContentRole.ANI_HISTORY
        BiliPaiNavKey.AniSettings -> BiliPaiNavEntryContentRole.ANI_SETTINGS
        is BiliPaiNavKey.AniDetail -> BiliPaiNavEntryContentRole.ANI_DETAIL
        is BiliPaiNavKey.AniPlayer -> BiliPaiNavEntryContentRole.ANI_PLAYER

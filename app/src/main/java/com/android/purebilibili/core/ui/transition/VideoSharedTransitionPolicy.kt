 ...
 */
// ★ 参考 PiliPala / B站官方封面比例, 从 16:10 调整为 16:9
internal const val VIDEO_SHARED_COVER_ASPECT_RATIO = 16f / 9f
private const val HOME_SOURCE_ROUTE = "home"
// ★ 参考 PiliPala 的转场节奏整体提速(其 Hero 过渡约 200ms 量级),
//   原 280/360/480 偏慢, 观感上像卡顿
internal const val VIDEO_SHARED_TRANSITION_FAST_DURATION_MILLIS = 180
internal const val VIDEO_SHARED_TRANSITION_STANDARD_DURATION_MILLIS = 220
internal const val VIDEO_SHARED_TRANSITION_SLOW_DURATION_MILLIS = 300
